...
namespace MonsterQuest
{
    ...
    {
        public static readonly CardinalDirection[] cardinalDirections = Enum.GetValues(typeof(CardinalDirection)).Cast<CardinalDirection>().ToArray();
