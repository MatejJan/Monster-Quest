...
namespace MonsterQuest.Effects
{
    ...
    public class Armor : Effect, IArmorClassRule
    {
        ...
        public IntegerValue GetArmorClass(Creature creature)
        {
            ...
            int? dexterityModifier = null;

            // Light armor has the full dexterity modifier applied.
            if (armorType.category == ArmorCategory.Light) dexterityModifier = creature.abilityScores.dexterity.modifier;

            // Medium armor has the dexterity modifier applied up to a maximum of 2.
            if (armorType.category == ArmorCategory.Medium) dexterityModifier = Math.Min(creature.abilityScores.dexterity.modifier, 2);
