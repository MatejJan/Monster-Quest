...
namespace MonsterQuest.Effects
{
    ...
    public class RangedWeaponAttack : RangedAttack, IAttackRollMethodRule
    {
        ...
        public MultipleValue<AttackRollMethod> GetAttackRollMethod(AttackAction attackAction)
        {
            ...
            Creature nearestHostileCreature = attackAction.gameState.combat.creatures.Where(creature => attackAction.gameState.combat.AreHostile(attackAction.attacker, creature)).OrderBy(hostile => attackAction.gameState.combat.GetDistance(attackAction.attacker, hostile)).First();
